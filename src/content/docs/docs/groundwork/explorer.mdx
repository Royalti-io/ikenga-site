...
![The groundwork explorer with the plan board open in a tab — file tree on the left, the live board.html rendered in the viewer, file metadata in the right rail](/assets/groundwork/explorer.png)
...
![The design-system profile's explorer in gallery mode — a grid of live design-mockup thumbnails, lazy-loaded](/assets/groundwork/explorer-gallery.png)
...
![The cross-plan plans index — one card per plan with a work-package progress bar, profile chip, drift indicator, and drill-in buttons to each plan's explorer and board](/assets/groundwork/plans-index.png)
